package com.wysoft.https_lottery.test;
...
import com.wysoft.https_lottery.action.UserController;
...
public class ApplicationTests {
	...
	public void testUserController() throws Exception {
		...
		// 1、get查一下user列表，应该为空
		request = get("/users/");
		mvc.perform(request).andExpect(status().isOk()).andExpect(content().string(equalTo("[]"))).andDo(MockMvcResultHandlers.print());
